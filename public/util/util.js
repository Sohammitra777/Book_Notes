...
function bookDivCreation({ id, name, rating }) {
    ...
    const seperationDiv1 = Object.assign(document.createElement("div"), {
        className: "div1",
    });
    const seperationDiv2 = Object.assign(document.createElement("div"), {
        className: "div2",
    });
